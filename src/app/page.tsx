...
export default function Home() {
  ...
  return (
    <main className="flex h-full w-full min-h-screen flex-col bg-gray-800 items-center justify-center">
      {/* Advise Card  */}
      <div className="relative w-[360px] h-[350px] bg-gray-700 space-y-8 py-8 rounded-xl px-6 text-center">
        ...
        <div className="x w-full flex justify-between items-center gap-4">
          ...
          <div className="w-full h-[1px] bg-gray-500" />
          {/* Dice button  */}
          <div className="absolute flex justify-center items-center bottom-[-65px] left-1/2 -translate-x-1/2 -translate-y-1/2  w-16 h-16 bg-green-400 hover:bg-green-500 rounded-full cursor-pointer">
